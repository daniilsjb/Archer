...
uint32_t disassemble_instruction(Chunk* chunk, uint32_t offset)
{
    ...
    switch (instruction) {
        ...
        case OP_BITWISE_LEFT_SHIFT:  return simple_instruction("OP_BITWISE_LEFT_SHIFT", offset);
        case OP_BITWISE_RIGHT_SHIFT: return simple_instruction("OP_BITWISE_RIGHT_SHIFT", offset);
        ...
        case OP_JUMP_IF_NOT_EQUAL:   return jump_instruction("OP_JUMP_IF_NOT_EQUAL", 1, chunk, offset);
        ...
        default:                     return unknown_instruction(instruction, offset);
    }
}