...
typedef enum {
    ...
    /* Classes */
    OP_CLASS, OP_INHERIT, OP_LOAD_PROPERTY, OP_LOAD_PROPERTY_SAFE, OP_STORE_PROPERTY, OP_STORE_PROPERTY_SAFE, OP_METHOD, OP_INVOKE, OP_INVOKE_SAFE, OP_GET_SUPER, OP_SUPER_INVOKE,
